...
import space.harbour.kotlin.jooq.generated.keys.UKR43AF9AP4EDM43MMTQ01ODDJ6
import space.harbour.kotlin.jooq.generated.keys.USERS_PKEY
...
open class Users(
     ...
     */
    val ROLE: TableField<UsersRecord, String?> = createField(DSL.name("role"), SQLDataType.VARCHAR(255).nullable(false), this, "")
    ...
    override fun getUniqueKeys(): List<UniqueKey<UsersRecord>> = listOf(UKR43AF9AP4EDM43MMTQ01ODDJ6)
